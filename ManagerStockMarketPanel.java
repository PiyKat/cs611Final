...
// Company & Symbol, Date, previous price, current price, changes, & changes in 90 days

public class ManagerStockMarketPanel extends JPanel {
  ...
  class StockJPanel extends JPanel {
    ...
    class updateActionListener implements ActionListener {
      ...
      public void actionPerformed(ActionEvent e) {
        stockDetail = sc.returnStockMap(stockSymbol);
    ...
    public StockJPanel(String _stockSymbol) {
      ...
      JButton updateJButton = new JButton("Update Stock");
  ...
  public ManagerStockMarketPanel(String stockId) {
